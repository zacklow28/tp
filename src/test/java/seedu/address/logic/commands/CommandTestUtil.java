...
public class CommandTestUtil {
    ...
    public static final String INVALID_ALLERGY_DESC = " " + PREFIX_ALLERGY + "hubby*"; // '*' not allowed in allergies
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withAllergies(VALID_ALLERGY_FRIEND).withPriority(VALID_PRIORITY_AMY).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB)
                .withAllergies(VALID_ALLERGY_HUSBAND, VALID_ALLERGY_FRIEND).withPriority(VALID_PRIORITY_BOB).build();
    }
