    ...
    public AddCommand parse(String args) throws ParseException {
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(args, PREFIX_NAME, PREFIX_GENDER, PREFIX_HEIGHT, PREFIX_WEIGHT, PREFIX_PHONE,
                        PREFIX_EMAIL, PREFIX_DIET, PREFIX_PRIORITY, PREFIX_MEETING_DATE, PREFIX_TAG);
        ...
        argMultimap.verifyNoDuplicatePrefixesFor(PREFIX_NAME, PREFIX_GENDER, PREFIX_HEIGHT, PREFIX_WEIGHT, PREFIX_PHONE,
                PREFIX_EMAIL, PREFIX_DIET, PREFIX_PRIORITY, PREFIX_MEETING_DATE);
        ...
        Person person = new Person(name, gender, height, weight, phone, email, diet, priority, meetingDate, tagList);
