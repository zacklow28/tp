    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            ...
            new Person(new Name("David Li"), new Gender("m"), new Height("1.8"), new Weight("82"),
                    ...
                    new Priority("high"), new MeetingDate("2025-09-10"), EMPTY_REMARK, getAllergySet("fish")),
            new Person(new Name("Irfan Ibrahim"), new Gender("m"), new Height("1.78"), new Weight("75"),
                    ...
                    new Priority("low"), new MeetingDate("2025-10-28"), EMPTY_REMARK, getAllergySet("peanuts")),
